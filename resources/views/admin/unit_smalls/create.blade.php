...
@section('title', 'Tambah Satuan Kecil Baru')
...
@section('content')
    <div class="container-fluid px-6 py-4">
        ...
        <div class="d-flex justify-content-between align-items-center mb-6">
            <div>
                <h1 class="h3 mb-2 text-gray-900 font-weight-bold">Tambah Satuan Kecil Baru</h1>
                <p class="text-muted">Buat satuan kecil baru untuk sistem pengukuran</p>
            </div>
        ...
        <div class="card shadow-sm border-0">
            <div class="card-header bg-transparent py-3">
                <h5 class="card-title mb-0 text-gray-900 font-weight-bold">
                    <i class="mdi mdi-plus-box-outline me-2"></i>Form Tambah Satuan Kecil
                </h5>
            </div>
            <div class="card-body">
                <form action="{{ route('unit-smalls.store') }}" method="POST" id="unitSmallForm">
                    @csrf
                    ...
                    <div class="mb-4">
                        ...
                        <div class="form-text text-muted mt-2">
                            <small>
                                ...
                                Masukkan nama lengkap satuan kecil
                            </small>
                        </div>
                    </div>
                    ...
                    <div class="alert alert-info border-0 bg-light-info">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                <h6 class="alert-heading mb-2 text-info">Informasi Satuan Kecil</h6>
                                <p class="mb-0 small">
                                    Satuan kecil digunakan untuk pengukuran detail dalam sistem.
                    ...
                    <div class="d-flex justify-content-end align-items-center gap-3 pt-4 border-top">
                        ...
                        <button type="submit" class="btn btn-success btn-lg px-5" id="submitBtn">
                            <i class="mdi mdi-content-save-check me-2"></i>Simpan Satuan Kecil
                        </button>
                    </div>
                </form>
            </div>
