...
@section('title', 'Edit Satuan Kecil - ' . $data->name)
...
@section('content')
    <div class="container-fluid px-6 py-4">
        ...
        <div class="d-flex justify-content-between align-items-center mb-6">
            <div>
                <h1 class="h3 mb-2 text-gray-900 font-weight-bold">Edit Satuan Kecil</h1>
        ...
        <div class="row">
                ...
                <div class="card shadow-sm border-0">
                    <div class="card-header bg-transparent py-3">
                        <h5 class="card-title mb-0 text-gray-900 font-weight-bold">
                            <i class="mdi mdi-pencil-box-outline me-2"></i>Form Edit Satuan Kecil
                        </h5>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('unit_smalls.update', $data->id) }}" method="POST" id="unitSmallForm">
                            ...
                            <div class="mb-4">
                                <label for="name" class="form-label fw-semibold text-gray-700">
                                    Nama Satuan Kecil <span class="text-danger">*</span>
                                </label>
                                <input type="text" id="name" name="name" value="{{ old('name', $data->name) }}"
                                    placeholder="Contoh: Gram, Mililiter, Sentimeter"
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" id="abbreviation" name="abbreviation"
                                    value="{{ old('abbreviation', $data->abbreviation) }}" placeholder="Contoh: g, ml, cm"
                            ...
                            <div class="d-flex justify-content-end align-items-center gap-3 pt-4 border-top">
                                ...
                                <button type="submit" class="btn btn-success btn-lg px-5" id="submitBtn">
                                    <i class="mdi mdi-content-save-check me-2"></i>Perbarui Satuan Kecil
                                </button>
                            </div>
                        </form>
                    </div>
            ...
            <!-- Sidebar Information -->
            <div class="col-lg-4">
                <!-- Unit Small Info Card -->
                <div class="card shadow-sm border-0 mb-4">
                    <div class="card-header bg-transparent py-3">
                        <h5 class="card-title mb-0 text-gray-900 font-weight-bold">
                            <i class="mdi mdi-information-outline me-2"></i>Informasi Satuan Kecil
                        </h5>
                    </div>
                    <div class="card-body">
                        <div class="text-center mb-4">
                            <div class="bg-light-success rounded-circle d-inline-flex align-items-center justify-content-center mb-3"
                                ...
                                <i class="mdi mdi-weight-gram fs-2 text-success"></i>
                            </div>
                ...
                <div class="card shadow-sm border-0">
                    <div class="card-header bg-transparent py-3">
                        <h5 class="card-title mb-0 text-gray-900 font-weight-bold">
                            <i class="mdi mdi-lightbulb-on-outline me-2"></i>Tips Satuan Kecil
                        </h5>
                    </div>
                    <div class="card-body">
...
@push('scripts')
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            const form = document.getElementById('unitSmallForm');
        ...
        function confirmDelete() {
            Alert.confirm(
                `Hapus Satuan Kecil "{{ $data->name }}"?`,
                'Satuan kecil akan dihapus permanen. Tindakan ini tidak dapat dibatalkan!',
                function() {
