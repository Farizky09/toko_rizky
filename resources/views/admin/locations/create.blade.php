                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-4">
                        ...
                        <select id="type" name="type"
                            ...
                            <option value="ruangan" {{ old('type') == 'ruangan' ? 'selected' : '' }}>Ruangan</option>
                            <option value="rak" {{ old('type') == 'rak' ? 'selected' : '' }}>Rak</option>
                ...
                <div class="alert alert-info border-0 bg-light-info">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            ...
                            <p class="mb-0 small">
                                Lokasi digunakan untuk mengorganisir area spesifik dalam cabang seperti gudang, ruangan, atau rak penyimpanan.
