                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-4">
                                    ...
                                    <input type="text" id="code" name="code"
                                        value="{{ old('code', $data->code) }}" placeholder="Contoh: CAB-001, B001, MAIN"
                ...
                <div class="card shadow-sm border-0 mb-4">
                    ...
                    <div class="card-body">
                        <div class="text-center mb-4">
                            ...
                            <span
                                class="inline-flex items-center gap-1 px-3 py-1 rounded-full text-sm font-medium {{ $data->status ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800' }}">
                                @if ($data->status)
                        ...
                        <div class="space-y-3">
                            ...
                            <div class="flex items-start gap-3">
                                ...
                                <div class="flex-1">
                                    ...
                                    <p class="text-sm text-gray-600">{{ $data->city }}, {{ $data->province }}
                                        {{ $data->postal_code }}</p>
                                </div>
                            </div>
...
@push('scripts')
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const requiredFields = [codeInput, nameInput, addressInput, cityInput, provinceInput, postalCodeInput,
                statusInput
            ];
